...
namespace FinalProject.Pages
{
    public class ReadEmailModel : PageModel
    {
        ...
        public IActionResult OnGet(string emailid)
        {
            try
            {
                string connectionString = "Server=tcp:abcdgroup.database.windows.net,1433;Initial Catalog=DBforProjectCS;Persist Security Info=False;User ID=abcd;Password=cs4361234.;MultipleActiveResultSets=False;Encrypt=True;TrustServerCertificate=False;Connection Timeout=30;"; // Replace with your actual connection string
